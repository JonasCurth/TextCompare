...
namespace utils
{
    public class Comparer
    {
        ...
        public List<Diff> Compare(string reference, string textToCompare, bool checklines)
        {
            ...
            {
                deadline = DateTime.Now + new TimeSpan(((long)(this.Timeout * 1000)) * 10000);
            }
        ...
        /// <param name="checklines"></param>
        /// <param name="deadline"></param>
        /// <returns></returns>
        private List<Diff> Compare(string reference, string textToCompare, bool checklines, DateTime deadline)
        {
            ...
            diffs = this.Compute(reference, textToCompare, checklines, deadline);
    ...
    /**
        ...
        */
        private List<Diff> Compute(string reference, string textToCompare, bool checklines, DateTime deadline)
        {
            ...
            if (-1 != i)
            {
                ...
                Operation op = (reference.Length > textToCompare.Length) ? Operation.DELETE : Operation.INSERT;
            ...
            string[] hm = this.Halfmatch(reference, textToCompare);
            ...
            if (hm != null)
            {
                ...
                List<Diff> diffs_a = Compare(text1_a, text2_a, checklines, deadline);
                List<Diff> diffs_b = Compare(text1_b, text2_b, checklines, deadline);
            ...
            if (checklines && reference.Length > 100 && textToCompare.Length > 100)
            {
                ...
                return diff_bisect(reference, textToCompare, deadline);
        }
    ...
    /**
        ...
        * @return List of Diff objects.
        */
        private List<Diff> LineMode(string reference, string textToCompare, DateTime deadline)
        {
            // Scan the text on a line-by-line basis first.
            Object[] b = this.LinesToChars(reference, textToCompare);

            reference = b[0] as string;
            textToCompare = b[1] as string;

            List<string> linearray = (List<string>)b[2];

            List<Diff> diffs = this.Compare(reference, textToCompare, false, deadline);
    ...
    /**
        ...
        */
        private List<Diff> diff_bisectSplit(string text1, string text2,
            ...
            List<Diff> diffs = Compare(text1a, text2a, false, deadline);
            List<Diff> diffsb = Compare(text1b, text2b, false, deadline);
        ...
        protected void CharsToLines(ICollection<Diff> diffs, List<string> lineArray)
        {
            StringBuilder text;
        ...
        {
            int text1_length = reference.Length;
            int text2_length = textToCompare.Length;

            int n = Math.Min(reference.Length, textToCompare.Length);

            for (int i = 1; i <= n; i++)
            {
                if (reference[text1_length - i] != textToCompare[text2_length - i])
                {
                    return i - 1;
                }
            }
    ...
    /**
        ...
        */
        ...
        protected string[] Halfmatch(string reference, string textToCompare)
        {
            ...
            string[] hm1 = this.HalfmatchI(longtext, shorttext, (longtext.Length + 3) / 4);

            // Check again based on the third quarter.
            string[] hm2 = this.HalfmatchI(longtext, shorttext, (longtext.Length + 1) / 2);
            ...
            {
                hm = new string[] { hm[2], hm[3], hm[0], hm[1], hm[4] };
            }
